      ...
      <nav className="bg-white dark:bg-gray-900 ">
              ...
              {logged ? (
                ...
                <>
                  <a
                    ...
                    className=" mt-2 text-gray-700 dark:text-white hover:dark:text-white hover:text-gray-900  cursor-pointer"
                  >
                    Inscription
                  </a>
                  <a
        ...
        {toogle && (
          <div className="p-5 md:hidden transition-all duration-150 ease-in-out">
            <a
              onClick={() => navigate("/")}
              className="block py-2 px-4 text-sm dark:text-white  cursor-pointer"
            >
              Accueil
            </a>
            <a
            ...
            <div className="block py-2 px-4 text-sm dark:text-white  cursor-pointer">
              <ThemeButton />
            </div>
          </div>
        )}
