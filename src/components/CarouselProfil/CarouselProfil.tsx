...
export const CarouselExpo: React.FC<CarouselExpo> = ({
  arrayImage,
  Title,
  SecondTitle,
}) => {
          ...
          >
            ...
            <div className="p-4 text-center">
              ...
              <p className="text-lg">
                ...
                Fugiat, consectetur? Aperiam laboriosam modi tenetur deserunt
                est repellendus nam, amet odit provident! Quas ipsa tempora
                consequatur alias, neque accusamus necessitatibus dicta.
              </p>
            </div>
          </SwiperSlide>
        ))}
